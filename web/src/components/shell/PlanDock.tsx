...
export function PlanDock({ project, features }: { project: string; features: string[] }) {
  ...
  if (features.length === 0) {
    return (
      <div
        ...
        className="pointer-events-auto w-[200px] rounded-xl border border-white/10 bg-[var(--color-bg-overlay)]/55 p-3 text-[11px] text-[var(--color-text-3)] backdrop-blur-md"
      >
  ...
  return (
    <div
      ...
      className="pointer-events-auto w-[200px] rounded-xl border border-[var(--color-border-subtle)] bg-[var(--color-bg-overlay)]/55 p-3 backdrop-blur-md"
    >

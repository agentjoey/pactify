...
//
// Body is dark charcoal #ffffff with white-alpha outline; the caste color shows
...
const FULL: Record<Caste, JSX.Element> = {
  queen: (
    <g transform="rotate(45 24 24)" strokeLinecap="round">
      ...
      <path d="M20.5 12 C18 10, 17 8.5, 16.5 7 M27.5 12 C30 10, 31 8.5, 31.5 7" stroke="rgba(18,22,31,.35)" strokeWidth="1.2" fill="none" />
      <circle cx="24" cy="15.5" r="5" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      ...
      <ellipse cx="24" cy="24.5" rx="4" ry="5" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <ellipse cx="24" cy="37" rx="6.6" ry="8" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <path d="M18.4 34 C20 35, 28 35, 29.6 34 M18 38.5 C20 39.5, 28 39.5, 30 38.5" stroke="#ECC678" strokeWidth="1.6" fill="none" />
    </g>
  ),
  guard: (
    <g transform="rotate(45 24 24)" strokeLinecap="round">
      <path d="M18.5 11 C16 8.5, 15.5 7, 15.5 5.5 M29.5 11 C32 8.5, 32.5 7, 32.5 5.5" stroke="rgba(18,22,31,.35)" strokeWidth="1.2" fill="none" />
      <circle cx="24" cy="16.5" r="7" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <path d="M17.5 20 C14.5 22, 13.5 24.5, 14 27 M30.5 20 C33.5 22, 34.5 24.5, 34 27" stroke="rgba(18,22,31,.42)" strokeWidth="1.6" fill="none" />
      <rect x="17.5" y="14.1" width="13" height="3.6" rx="1.8" fill="#93B4F2" opacity=".92" />
      <ellipse cx="24" cy="27.5" rx="3.6" ry="4.4" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <ellipse cx="24" cy="38.5" rx="5.6" ry="6.6" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
  ...
  builder: (
    <g transform="rotate(45 24 24)" strokeLinecap="round">
      ...
      <circle cx="24" cy="17.5" r="5" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <path d="M20.8 13.8 L19.2 11.6 M27.2 13.8 L28.8 11.6" stroke="rgba(18,22,31,.4)" strokeWidth="1.3" />
      <ellipse cx="24" cy="26" rx="3.8" ry="4.6" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <path d="M20.4 23.5 C16 22, 14 23.5, 12.5 26 M27.6 23.5 C32 22, 34 23.5, 35.5 26 M20.6 27.5 C17 28.5, 15.5 30.5, 15 33 M27.4 27.5 C31 28.5, 32.5 30.5, 33 33" stroke="rgba(18,22,31,.35)" strokeWidth="1.2" fill="none" />
      <ellipse cx="24" cy="37.5" rx="5.8" ry="7" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
  ...
  catcher: (
    <g transform="rotate(45 24 24)" strokeLinecap="round">
      ...
      <ellipse cx="31" cy="7.5" rx="2" ry="1.5" fill="#D96B66" stroke="#f1f3f5" strokeWidth=".8" />
      <path d="M29.6 6.2 L28.8 5.2 M32.4 6.2 L33.2 5.2" stroke="rgba(18,22,31,.5)" strokeWidth=".9" />
      <path d="M20.8 13.5 L19.2 11.2" stroke="rgba(18,22,31,.4)" strokeWidth="1.3" />
      <circle cx="24" cy="17.5" r="5" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <ellipse cx="24" cy="26" rx="3.8" ry="4.6" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <path d="M20.4 23.5 C16 22, 14 23.5, 12.5 26 M20.6 27.5 C17 28.5, 15.5 30.5, 15 33 M27.4 27.5 C31 28.5, 32.5 30.5, 33 33" stroke="rgba(18,22,31,.35)" strokeWidth="1.2" fill="none" />
      <ellipse cx="24" cy="37.5" rx="5.8" ry="7" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
  ...
  brewer: (
    <g transform="rotate(45 24 24)" strokeLinecap="round">
      <rect x="17.5" y="2.5" width="13" height="10" rx="1.6" fill="#FFF4DC" stroke="#f1f3f5" strokeWidth="1" />
  ...
  painter: (
    <g transform="rotate(45 24 24)" strokeLinecap="round">
      <path d="M16.5 8.5 C16.5 4.5, 21 2, 25.5 3.5 C30 5, 31 9.5, 28 12 C26.5 13.2, 24.8 12.6, 24.3 11.2 C23.8 9.8, 22.3 9.4, 21 9.8 C19.5 10.3, 16.5 10.5, 16.5 8.5 Z" fill="#FFF4DC" stroke="#f1f3f5" strokeWidth="1" />
  ...
  scout: (
    <g transform="rotate(45 24 24)" strokeLinecap="round">
      ...
      <circle cx="24" cy="17.5" r="5" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <circle cx="22" cy="17" r="1.9" fill="none" stroke="rgba(18,22,31,.55)" strokeWidth="1" />
      <circle cx="26.6" cy="17" r="1.9" fill="none" stroke="rgba(18,22,31,.55)" strokeWidth="1" />
      <path d="M23.9 17 L24.7 17" stroke="rgba(18,22,31,.55)" strokeWidth="1" />
      <ellipse cx="24" cy="26" rx="3.8" ry="4.6" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
      <path d="M20.4 23.5 C16 22, 14 23.5, 12.5 26 M27.6 23.5 C32 22, 34 23.5, 35.5 26 M20.6 27.5 C17 28.5, 15.5 30.5, 15 33 M27.4 27.5 C31 28.5, 32.5 30.5, 33 33" stroke="rgba(18,22,31,.35)" strokeWidth="1.2" fill="none" />
      <ellipse cx="24" cy="37.5" rx="5.8" ry="7" fill="#ffffff" stroke="rgba(18,22,31,.32)" strokeWidth="1.2" />
...
const SMALL: Record<Caste, JSX.Element> = {
  queen: (
    <g transform="rotate(45 24 24)">
      <path d="M19 5.5 L21.5 9 L24 5 L26.5 9 L29 5.5 L28 10.5 L20 10.5 Z" fill="#ECC678" />
      <circle cx="24" cy="15.5" r="5.5" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
      <ellipse cx="24" cy="25" rx="4.4" ry="5.4" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
      <ellipse cx="24" cy="37.5" rx="6.6" ry="7.8" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
      <path d="M18.6 35.5 C20.5 36.5, 27.5 36.5, 29.4 35.5" stroke="#ECC678" strokeWidth="2" fill="none" />
    </g>
  ),
  guard: (
    <g transform="rotate(45 24 24)">
      <circle cx="24" cy="16.5" r="7.5" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
      <rect x="17" y="13.8" width="14" height="4.2" rx="2.1" fill="#93B4F2" />
      <ellipse cx="24" cy="28" rx="4" ry="4.8" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
      <ellipse cx="24" cy="39" rx="6" ry="7" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
  ...
  builder: (
    <g transform="rotate(45 24 24)">
      ...
      <circle cx="24" cy="17.5" r="5.5" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
      <ellipse cx="24" cy="27" rx="4.2" ry="5" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
      <ellipse cx="24" cy="38.5" rx="6.4" ry="7.5" fill="#ffffff" stroke="rgba(18,22,31,.4)" strokeWidth="1.6" />
  ...
  brewer: (
    <g transform="rotate(45 24 24)">
      <rect x="17.5" y="2.5" width="13" height="10" rx="1.6" fill="#FFF4DC" stroke="#f1f3f5" strokeWidth="1.2" />
  ...
  painter: (
    <g transform="rotate(45 24 24)">
      <path d="M16.5 8.5 C16.5 4.5, 21 2, 25.5 3.5 C30 5, 31 9.5, 28 12 C26.5 13.2, 24.8 12.6, 24.3 11.2 C23.8 9.8, 22.3 9.4, 21 9.8 C19.5 10.3, 16.5 10.5, 16.5 8.5 Z" fill="#FFF4DC" stroke="#f1f3f5" strokeWidth="1.2" />

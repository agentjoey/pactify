...
type Config struct {
	...
	// Plan runs remote plan generate/apply, policy-gated. Nil = disabled.
...
func Run(ctx context.Context, cfg Config) error {
	...
	if cfg.Resolve != nil || cfg.Stint != nil || cfg.Orch != nil || cfg.Plan != nil {
		...
		ex := &remoteexec.Executor{
			Account:    cfg.Account,
			Dispatcher: &remoteexec.Dispatcher{Account: cfg.Account, Resolve: cfg.Resolve, Stint: cfg.Stint, Orch: cfg.Orch, Plan: cfg.Plan},
		}
